...
export default {
  ...
  methods: {
    ...
    _setActiveTabOrDefault(val, tab) {
      ...
      this._sortQuery = (tab && tab.sortQuery) || this._sortQuery || ''
      this._sortValue = (tab && tab.sortValue) || this._sortValue || ''
    },

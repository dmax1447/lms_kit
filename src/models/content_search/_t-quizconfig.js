...
export default {
  ...
  columns: [
    ...
    { name: 'title', position: 2, type: 'Text', isSortable: true, target: "_blank",
      hasOwnAction: true,
      linkTo() {
        const modulePath = ENV.QBANK_MODULE_NAME.replaceAll('-', '/')
        return `/subservices/${modulePath}/quiz-config/${this.id}/edit`
      },
    },
    {
      name: 'author_fio',
